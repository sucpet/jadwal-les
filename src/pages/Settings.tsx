...
import { Upload, Download, Trash2, AlertTriangle, CheckCircle2, Database } from 'lucide-react';
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        <h2 className="font-semibold text-gray-900 mb-3">Ringkasan Data</h2>
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="flex justify-between"><span className="text-gray-500">Guru</span><span className="font-medium">{data.teachers.length}</span></div>
          <div className="flex justify-between"><span className="text-gray-500">Murid</span><span className="font-medium">{data.students.length}</span></div>
          <div className="flex justify-between"><span className="text-gray-500">Paket aktif</span><span className="font-medium">{data.packages.length}</span></div>
          <div className="flex justify-between"><span className="text-gray-500">Total sesi</span><span className="font-medium">{data.sessions.length}</span></div>
        </div>
      </div>
      ...
      {/* Export */}
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        <h2 className="font-semibold text-gray-900 mb-1">Export / Backup</h2>
        <p className="text-sm text-gray-500 mb-4">
      ...
      <div className="bg-white border border-red-200 rounded-xl p-5">
        ...
        <p className="text-sm text-gray-500 mb-4">Hapus semua data. Tidak bisa dibatalkan.</p>
        <button
